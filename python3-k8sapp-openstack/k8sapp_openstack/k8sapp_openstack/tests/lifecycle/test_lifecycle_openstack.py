...
class OpenstackAppLifecycleOperatorTest(dbbase.BaseHostTestCase):
    ...
    @mock.patch('k8sapp_openstack.utils.create_netapp_ca_cert_secret')
    ...
    def test_create_app_specific_resources_pre_apply_success(
        ...
        mock_create_netapp_ca_cert_secret,
        ...
        *_
        ...
        mock_create_netapp_ca_cert_secret.assert_called_once()
    ...
    @mock.patch('k8sapp_openstack.lifecycle.lifecycle_openstack.lifecycle_utils')
    @mock.patch('k8sapp_openstack.utils.delete_netapp_ca_cert_secret')
    ...
    def test_delete_app_specific_resources_post_remove(
            ...
            mock_delete_netapp_ca_cert_secret,
        ...
        mock_delete_netapp_ca_cert_secret.assert_called_once()
